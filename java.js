...
.controller("tablerowController", function($rootScope, $http) {
    ...
    $http.get("http://localhost:3001/api/products").then((res) => $rootScope.namelist = res.data);
...
.controller("tablcolumnController", function($rootScope, $http, ) {
    ...
    $http.get("http://localhost:3001/api/products").then(function (res) { $rootScope.namelist = res.data; })
